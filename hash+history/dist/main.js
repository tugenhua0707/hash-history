...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BaseRouter; });
...
var BaseRouter = function () {
  function BaseRouter(list) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, BaseRouter);

    this.list = list;
  }

  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(BaseRouter, [{
    key: 'render',
    value: function render(state) {
      var ele = this.list.find(function (ele) {
        return ele.path === state;
      });
      ele = ele ? ele : this.list.find(function (ele) {
        return ele.path === '*';
      });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hash__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__history__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routerList__ = __webpack_require__(85);
...
var WebRouter = function () {
  function WebRouter(_ref) {
    var _ref$mode = _ref.mode,
        mode = _ref$mode === undefined ? 'hash' : _ref$mode,
        routerList = _ref.routerList;

    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, WebRouter);

    this.router = mode === 'hash' ? new __WEBPACK_IMPORTED_MODULE_2__hash__["a" /* HashRouter */](routerList) : new __WEBPACK_IMPORTED_MODULE_3__history__["a" /* HistoryRouter */](routerList);
  }

  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(WebRouter, [{
    key: 'push',
...
var webRouter = new WebRouter({
  mode: MODE,
  routerList: __WEBPACK_IMPORTED_MODULE_4__routerList__["a" /* ROUTERLIST */]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__base_js__ = __webpack_require__(43);
...
var HashRouter = function (_BaseRouter) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(HashRouter, _BaseRouter);

  function HashRouter(list) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, HashRouter);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (HashRouter.__proto__ || Object.getPrototypeOf(HashRouter)).call(this, list));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(HashRouter, [{
    key: 'handler',
  ...
  return HashRouter;
}(__WEBPACK_IMPORTED_MODULE_4__base_js__["a" /* BaseRouter */]);
...
var HistoryRouter = function (_BaseRouter) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_inherits___default()(HistoryRouter, _BaseRouter);

  function HistoryRouter(list) {
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, HistoryRouter);

    var _this = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_possibleConstructorReturn___default()(this, (HistoryRouter.__proto__ || Object.getPrototypeOf(HistoryRouter)).call(this, list));
  ...
  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(HistoryRouter, [{
    key: 'handler',
    value: function handler() {
      var state = this.getState();
      this.render(state);
