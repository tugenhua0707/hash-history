...
var HistoryRoutes = function () {
  function HistoryRoutes() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_classCallCheck___default()(this, HistoryRoutes);
    ...
    window.addEventListener('popstate', function (e) {
      var path = _this.getState();
      _this.routes[path] && _this.routes[path]();
    });
  }
  // 获取路由路径


  __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(HistoryRoutes, [{
    key: 'getState',
